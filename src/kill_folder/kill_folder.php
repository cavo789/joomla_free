...
/**
 * AVONTURE Christophe - https://www.aesecure.com
 *
 * Date : 16/10/2015
 *
    ...
    foreach (new RecursiveIteratorIterator($it, RecursiveIteratorIterator::CHILD_FIRST) as $file) {
        if (($file->isDir()) && (!in_array($file->getFilename(), array('.', '..')))) {
            ...
            if (($file->isFile()) && ($file->getPathname()!=__FILE__)) {
                if (!(in_array($file->getPathname(), array($folder.'.htaccess',$folder.'index.html',$folder.'index.php')))) {
...
<html lang="fr">
   ...
   <body>
      ...
      <div class="container">
         <div class="page-header"><h1>aeSecure - Clean folders</h1></div>
         <div class="container">
