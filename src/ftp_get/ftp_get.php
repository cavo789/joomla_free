...
// Just after the connection, do you wish to change to a specific folder.
// If yes, mention its name here
$FTP_folder='';
...
// Let this variable empty to reuse the same name (backup.zip) or specify
// a new name here ("mysite_backup.zip" f.i.)
$FTP_LocalFileName='';
